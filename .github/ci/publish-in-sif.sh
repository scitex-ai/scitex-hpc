...
# (project=scitex-hpc, owner=ywatanabe1989, repo=scitex-hpc,
...
TMPDIR="/tmp/publish-scitex_hpc-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-hpc dist/* uploaded to PyPI via manual OIDC trusted publishing"

...
- [16_verifying-a-fix-is-live.md](16_verifying-a-fix-is-live.md) — three ways a fix reads as applied and is not (declared-not-applied / applied-in-wrong-place / doctrine-as-description); why the middle one needs a SECOND observer and destroys the signal; merged ≠ deployed ≠ effective; why a flake rate is the wrong statistic for a compounding failure. **NOTE: the CI runners have NO container/overlay — 14's freshness section is the target design, not the deployment**
